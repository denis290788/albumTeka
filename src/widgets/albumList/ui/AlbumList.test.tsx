...
import { useGetAlbumsQuery, useGetAlbumsByFolderQuery } from "@/entities/album/model/albumsApi";
import { useGetFolderByIdQuery } from "@/entities/folder/model/foldersApi";
import { mockAlbums } from "../../../shared/lib/test/__mocks__/albumsApi";
import { AlbumCardProps } from "@/entities/album/ui/AlbumCard";
...
jest.mock("../../../app/_providers/SearchContext", () => ({
    useSearch: jest.fn(),
}));
